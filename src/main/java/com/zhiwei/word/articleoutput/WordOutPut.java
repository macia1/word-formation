package com.zhiwei.word.articleoutput;

import com.zhiwei.entities.ArticleEntity;
...
public class WordOutPut {
    ...
    public Boolean beanJudgment(ArticleEntity articleEntity) {
        return Strings.isNotBlank(articleEntity.getTitle()) && Strings.isNotBlank(articleEntity.getUrl()) && Strings.isNotBlank(articleEntity.getContent());
    }
}
